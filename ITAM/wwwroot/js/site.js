...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function loadContract(vendorId) {
        ...
        $.ajax({
            ...
            error: function (xhr) {
                ...
                $contract.append(
                    '<option value="">Error load contract</option>'
                );
            }
        });
    }
    ...
    setTimeout(function () {
        ...
        console.log('Auto Vendor:', vendorId);
